  ...
  <body>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 content">
            ...
            <p>
              Kami menyediakan layanan pemeliharaan berkualitas tinggi yang dirancang untuk menjaga bisnis Anda tetap berjalan lancar. Dengan tim ahli yang berpengalaman, kami menangani segala kebutuhan pemeliharaan Anda, mulai dari
              perbaikan kelistrikan, pemeliharaan mekanikal, hingga solusi jaringan yang handal. Kami berkomitmen untuk memberikan pelayanan terbaik yang memastikan efisiensi dan keberlanjutan operasional bisnis Anda.
            </p>
    ...
    <section class="footer">
      ...
      <div class="credit">
        &copy; copyright @
        <?php echo date('Y'); ?>
        <span>wikiarlnm [Kelompok 1 - Pemograman Web Lanjut]</span>
      </div>
    </section>
    <!-- End Footer -->
